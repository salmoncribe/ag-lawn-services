...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-meadow hover:-translate-y-0.5 hover:bg-[#14532d]",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-[#eadbbd]",
        outline:
          "border border-border bg-white/70 text-foreground hover:bg-white/90",
        ghost: "text-foreground hover:bg-white/60",
        dark: "bg-[#102f1d] text-white hover:bg-[#0b2315]"
      },
      size: {
